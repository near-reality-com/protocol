 ...
 */
public fun Channel.hostAddress(): String = this.remoteAddress().toString().substringBefore(":")

/**
 * Gets the host address from the given channel handler context.
 */
public fun ChannelHandlerContext.hostAddress(): String = this.channel().hostAddress()
